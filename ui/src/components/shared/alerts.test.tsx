...
describe('AlertBanner', () => {
  it('renders error status message', () => {
    render(<AlertBanner prefix="" errorStatus="Network Error" variant="danger" />);

    expect(screen.getByText('Network Error')).toBeInTheDocument();
  });

  it('renders prefix with error status', () => {
    render(<AlertBanner prefix="API Error" errorStatus="Connection failed" variant="danger" />);

    expect(screen.getByText('API Error: Connection failed')).toBeInTheDocument();
  });

  it('renders with danger variant class', () => {
    const { container } = render(<AlertBanner prefix="" errorStatus="Error" variant="danger" />);
  ...
  it('renders with warning variant class', () => {
    const { container } = render(<AlertBanner prefix="" errorStatus="Warning" variant="warning" />);
  ...
  it('renders with info variant class', () => {
    const { container } = render(<AlertBanner prefix="" errorStatus="Info message" variant="info" />);
  ...
  it('is visible when initially rendered', () => {
    render(<AlertBanner prefix="" errorStatus="Visible alert" variant="info" />);
